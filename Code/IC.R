# source('./Rapport/Document_Methode/Code/IC.R')
library(raster)
...
png('./Rapport/Document_Methode/Figures/IC.png', res = 900, width = 200, height = 200, units = "mm")
...
plot0(); text(0,0,"Stresseurs", adj = c(.5,.5), font = 2); box3('24')
plot0(); text(0,0,"Empreinte\nde stress", adj = c(.5,.5), font = 2)
